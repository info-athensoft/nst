				...
				<div class=" col-md-8 col-sm-6">
					<div class="topbar-left">
						<ul>
							...
							<li><a href="#"><i class="fa fa-phone"></i> 888-888-8888</a></li>
							<li><a href="#"><i class="fa fa-map-marker"></i>
									8888 Rue mystreet Suite 888, Montreal</a></li>
						</ul>
					</div>
				</div>
							...
							<div class="main-menu">
								<ul class="nav navbar-nav navbar-right">
									...
									<li><a class="pagess" href="#"><spring:message code="menu-service-imm"/></a>
										<ul class="sub-menu">
											<li><a href="/service-commimm.html"><spring:message code="menu-service-commercial-imm"/></a></li>
											<li><a href="/service-familyimm.html"><spring:message code="menu-service-family-imm"/></a></li>
											<li><a href="/service-skillworkerimm.html"><spring:message code="menu-service-skillworker-imm"/></a></li>
										</ul></li>
									<li><a href="/service-appeal.html"><spring:message code="menu-service-appeal"/></a></li>
